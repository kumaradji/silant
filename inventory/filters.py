...
class MaintenanceFilter(django_filters.FilterSet):
    ...
    service_company = django_filters.CharFilter(field_name='service_company__first_name', lookup_expr='icontains',
                                                label='Организация, проводившая ТО содержит')

    class Meta:
        model = Maintenance
        fields = ['maintenance_type', 'serial_number', 'service_company']
